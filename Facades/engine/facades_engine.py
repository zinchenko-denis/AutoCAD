...
Этап 2 (раскладка, ATCLAD) с 22.07 живёт ОТДЕЛЬНЫМ модулем AClad
(свой бандл и движок clad_engine) — просьба Германа: боевой этап 1
не переустанавливается при итерациях раскладки.
