...
r0 = rws[0]
ok7 = r0[3] == "750, разн." and r0[4] == "2050, разн." and r0[5] == 3 and "разн." not in str(r0[1])
rep("OK" if ok7 else "BUG", "S7", f"СП01 с разными размерами: Ш={r0[3]!r}, В={r0[4]!r}, Тип={r0[1]!r}, n={r0[5]} (ожидание: «<первое>, разн.» в Ш/В, тип однороден)")
