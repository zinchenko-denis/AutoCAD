...
# остаток 16 мм между рядом 4 и низом окна — note, не дыра во весь ряд
ok(any("по высоте 16 < min_cut" in n for n in p["notes"]),
   "C30c: мелкий остаток под окном — note (%s)" % p["notes"])
